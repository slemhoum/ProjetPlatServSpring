										...
										<tr>
					                       ...
					                       <td>${p.delais}</td>
											<td> <div class="progress">
                                                <div class="progress-bar progress-bar-danger progress-bar-striped" role="progressbar" aria-valuenow=" ${p.etat}"  aria-valuemax="100" style="width:  ${p.etat}%">
                                                ${p.etat}%
                                                </div>
                                              </div></td>
											<td>
                                                <a  href="detailProjet.da?id=${p.id}" class="btn btn-primary">
                                                    <span><i class="ti-eye"></i> Info</span>
                  
                                                </a>
                                                 <a  href="ModifierProjet.da?id=${p.id}" class="btn btn-warning">
                                                    <span><i class="ti-marker-alt"></i> Modifier</span>
