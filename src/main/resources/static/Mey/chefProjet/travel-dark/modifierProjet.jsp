                ...
                <div class="col-12">
                  <div class="box">
                      <div class="box-header with-border">
                        <h4 class="box-title">Modifier Etat Projet</h4>
                      </div>
                    <div class="box-body">
                      <form action="updateEtat.da" method="Post">
                          <div class="form-body">
                              <div class="row">
                                  <div class="col-md-6">
                                      <div class="form-group">
                                        <label class="fw-700 fs-16 form-label">Etat</label>
                                        <input type="number" class="form-control" value="${projet.etat}"  name="etat">
                                           <input type="hidden" class="form-control" value="${projet.id}"  name="id">
                                      </div>
                                  </div>
                                  <!--/span-->
