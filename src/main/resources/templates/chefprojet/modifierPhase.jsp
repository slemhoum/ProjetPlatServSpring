                ...
                <div class="col-12">
                  <div class="box">
                      <div class="box-header with-border">
                        <h4 class="box-title">Modifier Phase</h4>
                      </div>
                    <div class="box-body">
                      <form action="#">
                          <div class="form-body">
                              <div class="row">
                                  <div class="col-md-6">
                                      <div class="form-group">
                                        <label class="fw-700 fs-16 form-label">Nom</label>
                                        <input type="text" class="form-control" placeholder="Nom"  value="${phase.nom}" name="nom">
                                      </div>
                                  </div>
                                  <!--/span-->
                                  <div class="col-md-6">
                                      <div class="form-group">
                                         ...
                                         <input type="text" class="form-control" placeholder="Description" value="${phase.description}" name="des">
                                      </div>
                                  </div>
                                  <!--/span-->
                              </div>
                              ...
                              <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                      <label class="fw-700 fs-16 form-label">Budget</label>
                                      <input type="number" class="form-control" placeholder="Budget" value="${phase.budget}" name="budget">
                                    </div>
                                </div>
                                  <!--/span-->
                                  <div class="col-md-6">
                                    <div class="form-group">
                                      <label class="fw-700 fs-16 form-label">Delais</label>
                                      <input type="text" class="form-control" placeholder="delais"  value="${phase.delais}" name="delais">
                                    </div>
                                </div>
                                  <!--/span-->
                              </div>
                              ...
                              <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                      ...
                                      <input type="number" class="form-control" placeholder="status" value="${phase.status}" name="status">
                                    </div>
                                </div>
                                  <!--/span-->
                              </div>
...
<!-- ./wrapper -->
	...
	<script src="chefProjet/travel-dark/js/pages/dashboard3.js"></script>
